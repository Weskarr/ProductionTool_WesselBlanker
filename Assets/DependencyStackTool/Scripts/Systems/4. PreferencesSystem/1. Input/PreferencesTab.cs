...
public class PreferencesTab : MonoBehaviour, ITab
{
    [Header("Tab Toggling")]
    ...
    [SerializeField] private Toggle _invertZoomingToggle;
    [SerializeField] private Slider _zoomingSpeedSlider;
    [SerializeField] private Slider _panningSpeedSlider;
    ...
    public event Action<bool> OnInvertZoomingChanged;
    public event Action<int> OnZoomingSpeedChanged;
    public event Action<int> OnPanningSpeedChanged;
    ...
    public void InvertChanged(bool value) => OnInvertZoomingChanged?.Invoke(value);
    public void ZoomingSpeedChanged(Single value) => OnZoomingSpeedChanged?.Invoke((int)value);
    public void PanningSpeedChanged(Single value) => OnPanningSpeedChanged?.Invoke((int)value);
